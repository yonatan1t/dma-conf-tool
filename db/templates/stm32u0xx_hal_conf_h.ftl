...
[#assign allModules = ["ADC","COMP","CRC","CRS","AES","DAC","I2C","IRDA","IWDG","LCD","LPTIM","OPAMP","PCD","RNG","RTC","SPI","SMARTCARD","TIM","TSC","UART","USART","WWDG"]]
...
/**
  ...
  */
  ...
  #define HSE_VALUE              [#if hse_value??]${hse_value}[#else]32000000[/#if]U /*!< Value of the External oscillator in Hz */
#endif /* HSE_VALUE */
...
#define  TICK_INT_PRIORITY            ([#if TICK_INT_PRIORITY??]${TICK_INT_PRIORITY}[#else](1U<<__NVIC_PRIO_BITS) - 1[/#if]U)    /*!< tick interrupt priority (lowest by default) */
