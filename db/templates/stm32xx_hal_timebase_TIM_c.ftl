...
[#if FamilyName =="STM32MP2"]
  ...
  uint32_t              uwPrescalerValue = 0;
[/#if]
[#if FamilyName =="STM32WL3" || FamilyName =="STM32N6"]
  uint32_t              uwTimclock;
...
[#if FamilyName=="STM32H5"]
  HAL_StatusTypeDef     status;
[/#if]
[#if DIE!="DIE500" && FamilyName!="STM32WL" && FamilyName!="STM32H7" && FamilyName!="STM32C0" && FamilyName!="STM32G4" && FamilyName!="STM32U5" && FamilyName!="STM32F0" && FamilyName!="STM32F1"  && FamilyName!="STM32F2" && FamilyName!="STM32F3" && FamilyName!="STM32F4" && FamilyName!="STM32F7" && FamilyName!="STM32G0" && FamilyName!="STM32L1" && FamilyName!="STM32L4" && FamilyName!="STM32H5" && FamilyName!="STM32WBA" && FamilyName!="STM32U3"]
...
[/#if]  
  ...
  else
  {
    ...
    [/#if]  
    [#if TIMAPB2Presc?? && TIMAPB2Presc!="1" && FamilyName!="STM32L0" && FamilyName!="STM32WBA"]
