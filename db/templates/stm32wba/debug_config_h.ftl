...
[#list BspIpDatas as SWIP]
    [#if SWIP.variables??]
        ...
        [#if variables.value?contains("DEBUG_SCM_SYSTEM_CLOCK_CONFIG")]
            ...
            [/#if]
            [#if variables.value?contains("DEBUG_BACK_FROM_DEEP_SLEEP")]
                    [#assign BFDS_PORT = IpName]
                    [#assign BFDS_PIN  = IpInstance]
            [/#if]
        [/#list]
    [/#if]
    [#if SWIP.bsp??]
      [#list SWIP.bsp as bsp]
            ...
            [/#if]
            [#if bsp.bspName?contains("DEBUG_BACK_FROM_DEEP_SLEEP")]
                [#assign useSCMBFDS = true]
            [/#if]
        [/#list]
    [/#if]
[/#list]
...
#define GPIO_DEBUG_SCM_SYSTEM_CLOCK_CONFIG                    {GPIOA, LL_PWR_GPIO_PIN_0}
[/#if]
...
#define GPIO_DEBUG_SCM_SETUP                                  {GPIOA, LL_PWR_GPIO_PIN_0}
[/#if]
...
#define GPIO_DEBUG_SCM_HSERDY_ISR                             {GPIOA, LL_PWR_GPIO_PIN_0}
[/#if]
...
#define GPIO_DEBUG_ADC_ACTIVATION                             {GPIOA, LL_PWR_GPIO_PIN_0}
[/#if]
...
#define GPIO_DEBUG_ADC_TEMPERATURE_ACQUISITION                {GPIOA, LL_PWR_GPIO_PIN_0}
[/#if]
...
#define GPIO_DEBUG_RNG_GEN_RAND_NUM                           {GPIOA, LL_PWR_GPIO_PIN_0}
[/#if]
...
#define GPIO_DEBUG_LOW_POWER_STOP_MODE_ACTIVE                 {GPIOA, LL_PWR_GPIO_PIN_0}
[/#if]
...
#define GPIO_DEBUG_LOW_POWER_STANDBY_MODE_ACTIVE              {GPIOA, LL_PWR_GPIO_PIN_0}
[/#if]
...
#define GPIO_DEBUG_SCHDLR_HNDL_NXT_TRACE                      {GPIOA, LL_PWR_GPIO_PIN_0}
[/#if]
...
#define GPIO_DEBUG_SCHDLR_EVNT_RGSTR                          {GPIOA, LL_PWR_GPIO_PIN_0}
[/#if]
...
#define GPIO_DEBUG_SCHDLR_HNDL_MISSED_EVNT                    {GPIOA, LL_PWR_GPIO_PIN_0}
[/#if]
...
#define GPIO_DEBUG_SCHDLR_EXEC_EVNT_TRACE                     {GPIOA, LL_PWR_GPIO_PIN_0}
[/#if]
...
#define GPIO_DEBUG_LLWCC_CMN_HG_ISR                           {GPIOA, LL_PWR_GPIO_PIN_0}
[/#if]
...
#define GPIO_DEBUG_LLHWC_CMN_LW_ISR                           {GPIOA, LL_PWR_GPIO_PIN_0}
[/#if]
...
#define GPIO_DEBUG_PHY_CLBR_ISR                               {GPIOA, LL_PWR_GPIO_PIN_0}
[/#if]
...
#define GPIO_DEBUG_PHY_CLBR_EXEC                              {GPIOA, LL_PWR_GPIO_PIN_0}
[/#if]
...
#define GPIO_DEBUG_RAL_STRT_TX                                {GPIOA, LL_PWR_GPIO_PIN_0}
[/#if]
...
#define GPIO_DEBUG_RAL_ISR_TRACE                              {GPIOA, LL_PWR_GPIO_PIN_0}
[/#if]
...
#define GPIO_DEBUG_RAL_STOP_OPRTN                             {GPIOA, LL_PWR_GPIO_PIN_0}
[/#if]
...
#define GPIO_DEBUG_RAL_STRT_RX                                {GPIOA, LL_PWR_GPIO_PIN_0}
[/#if]
...
#define GPIO_DEBUG_COEX_STRT_ON_IDLE                          {GPIOA, LL_PWR_GPIO_PIN_0}
[/#if]
...
#define GPIO_DEBUG_COEX_ASK_FOR_AIR                           {GPIOA, LL_PWR_GPIO_PIN_0}
[/#if]
...
#define GPIO_DEBUG_COEX_STRT_ONE_SHOT                         {GPIOA, LL_PWR_GPIO_PIN_0}
[/#if]
...
#define GPIO_DEBUG_COEX_FORCE_STOP_RX                         {GPIOA, LL_PWR_GPIO_PIN_0}
[/#if]
...
#define GPIO_DEBUG_RAL_SM_DONE_EVNT_CBK                       {GPIOA, LL_PWR_GPIO_PIN_0}
[/#if]
...
[#if useSCMBFDS]
#define USE_RT_DEBUG_BACK_FROM_DEEP_SLEEP                     (1)
#define GPIO_DEBUG_BACK_FROM_DEEP_SLEEP                       {${BFDS_PORT}, ${BFDS_PIN}}
[#else]
