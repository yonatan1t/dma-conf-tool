...
#define TASK_PRIO_TX_TO_HOST                    osPriorityNormal
[/#if]
[#if (myHash["BLE_MODE_CENTRAL"] == "Enabled") || (myHash["BLE_MODE_PERIPHERAL_CENTRAL"] == "Enabled")]
#define TASK_PRIO_CLIENT_DISCOVER               osPriorityNormal
[/#if]
[/#if]
[/#if]
...
[/#if]
[#if (myHash["THREAD"] == "Enabled") && (myHash["WPAN_RTOS_MODEL"] != "SINGLE_TASK") ]
...
[/#if]
[#if (myHash["BLE_MODE_CENTRAL"] == "Enabled") || (myHash["BLE_MODE_PERIPHERAL_CENTRAL"] == "Enabled")]
#define TASK_PRIO_CLIENT_DISCOVER               (15u)
#define TASK_PREEMP_CLIENT_DISCOVER             (0u)
...
[/#if]
[#if (myHash["BLE_MODE_CENTRAL"] == "Enabled") || (myHash["BLE_MODE_PERIPHERAL_CENTRAL"] == "Enabled")]
#define TASK_STACK_SIZE_CLIENT_DISCOVER         RTOS_STACK_SIZE_NORMAL
[/#if]
[/#if]
[#if (myHash["ZIGBEE"] == "Enabled") || (myHash["ZIGBEE_SKELETON"] == "Enabled") || (myHash["mac_802_15_4_SKELETON"] == "Enabled")]
...
[/#if]
[#if (myHash["THREAD"] == "Enabled") && (myHash["THREADX_STATUS"]?number == 1) && (myHash["WPAN_RTOS_MODEL"] != "SINGLE_TASK")]
