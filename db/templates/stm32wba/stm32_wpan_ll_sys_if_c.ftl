...
[#if (myHash["BLE"] == "Enabled") || (myHash["BLE_MODE_SKELETON"] == "Enabled") || (myHash["BLE_MODE_HOST_SKELETON"] == "Enabled") || ( myHash["WPAN_RTOS_MODEL"] == "SINGLE_TASK" && ((myHash["THREAD"] == "Enabled") || (myHash["THREAD_SKELETON"] == "Enabled")))]
[#if myHash["FREERTOS_STATUS"]?number == 1 ]
