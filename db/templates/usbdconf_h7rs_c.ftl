...
{
#t/* USER CODE BEGIN HAL_PCD_SetupStageCallback_PreTreatment */
#t
#t/* USER CODE END HAL_PCD_SetupStageCallback_PreTreatment */
  USBD_LL_SetupStage((USBD_HandleTypeDef*)hpcd->pData, (uint8_t *)hpcd->Setup);
#t/* USER CODE BEGIN HAL_PCD_SetupStageCallback_PostTreatment */
#t
#t/* USER CODE END HAL_PCD_SetupStageCallback_PostTreatment */
...
#endif /* USE_HAL_PCD_REGISTER_CALLBACKS */
{
#t/* USER CODE BEGIN HAL_PCD_DataOutStageCallback_PreTreatment */
#t
#t/* USER CODE END HAL_PCD_DataOutStageCallback_PreTreatment */
  USBD_LL_DataOutStage((USBD_HandleTypeDef*)hpcd->pData, epnum, hpcd->OUT_ep[epnum].xfer_buff);
#t/* USER CODE BEGIN HAL_PCD_DataOutStageCallback_PostTreatment */
#t
#t/* USER CODE END HAL_PCD_DataOutStageCallback_PostTreatment */
}
...
#endif /* USE_HAL_PCD_REGISTER_CALLBACKS */
{
#t/* USER CODE BEGIN HAL_PCD_DataInStageCallback_PreTreatment */
#t
#t/* USER CODE END HAL_PCD_DataInStageCallback_PreTreatment */
  USBD_LL_DataInStage((USBD_HandleTypeDef*)hpcd->pData, epnum, hpcd->IN_ep[epnum].xfer_buff);
#t/* USER CODE BEGIN HAL_PCD_DataInStageCallback_PostTreatment */
#t
#t/* USER CODE END HAL_PCD_DataInStageCallback_PostTreatment */
}
...
#endif /* USE_HAL_PCD_REGISTER_CALLBACKS */
{
#t/* USER CODE BEGIN HAL_PCD_SofCallback_PreTreatment */
#t
#t/* USER CODE END HAL_PCD_SofCallback_PreTreatment */	
  USBD_LL_SOF((USBD_HandleTypeDef*)hpcd->pData);
#t/* USER CODE BEGIN HAL_PCD_SofCallback_PostTreatment */
#t
#t/* USER CODE END HAL_PCD_SofCallback_PostTreatment */
}
...
#endif /* USE_HAL_PCD_REGISTER_CALLBACKS */
{ 
#t/* USER CODE BEGIN HAL_PCD_ResetCallback_PreTreatment */
#t
#t/* USER CODE END HAL_PCD_ResetCallback_PreTreatment */
...
#t/* USER CODE BEGIN HAL_PCD_ResetCallback_PostTreatment */
#t
#t/* USER CODE END HAL_PCD_ResetCallback_PostTreatment */
}
...
#endif /* USE_HAL_PCD_REGISTER_CALLBACKS */
{
#t/* USER CODE BEGIN HAL_PCD_SuspendCallback_PreTreatment */
#t
#t/* USER CODE END HAL_PCD_SuspendCallback_PreTreatment */
...
#endif /* USE_HAL_PCD_REGISTER_CALLBACKS */
{
#t/* USER CODE BEGIN HAL_PCD_ResumeCallback_PreTreatment */
#t
#t/* USER CODE END HAL_PCD_ResumeCallback_PreTreatment */
...
#t/* USER CODE BEGIN HAL_PCD_ResumeCallback_PostTreatment */
#t
#t/* USER CODE END HAL_PCD_ResumeCallback_PostTreatment */
}
...
#endif /* USE_HAL_PCD_REGISTER_CALLBACKS */
{
#t/* USER CODE BEGIN HAL_PCD_ISOOUTIncompleteCallback_PreTreatment */
#t
#t/* USER CODE END HAL_PCD_ISOOUTIncompleteCallback_PreTreatment */
  USBD_LL_IsoOUTIncomplete((USBD_HandleTypeDef*)hpcd->pData, epnum);
#t/* USER CODE BEGIN HAL_PCD_ISOOUTIncompleteCallback_PostTreatment */
#t
#t/* USER CODE END HAL_PCD_ISOOUTIncompleteCallback_PostTreatment */
...
#endif /* USE_HAL_PCD_REGISTER_CALLBACKS */
{
#t/* USER CODE BEGIN HAL_PCD_ISOINIncompleteCallback_PreTreatment */
#t
#t/* USER CODE END HAL_PCD_ISOINIncompleteCallback_PreTreatment */
  USBD_LL_IsoINIncomplete((USBD_HandleTypeDef*)hpcd->pData, epnum);

#t/* USER CODE BEGIN HAL_PCD_ISOINIncompleteCallback_PostTreatment */
#t
#t/* USER CODE END HAL_PCD_ISOINIncompleteCallback_PostTreatment */
}
...
#endif /* USE_HAL_PCD_REGISTER_CALLBACKS */
{
#t/* USER CODE BEGIN HAL_PCD_ConnectCallback_PreTreatment */
#t
#t/* USER CODE END HAL_PCD_ConnectCallback_PreTreatment */	
  USBD_LL_DevConnected((USBD_HandleTypeDef*)hpcd->pData);
#t/* USER CODE BEGIN HAL_PCD_ConnectCallback_PostTreatment */
#t
#t/* USER CODE END HAL_PCD_ConnectCallback_PostTreatment */	
}
...
#endif /* USE_HAL_PCD_REGISTER_CALLBACKS */
{
#t/* USER CODE BEGIN HAL_PCD_DisconnectCallback_PreTreatment */
#t
#t/* USER CODE END HAL_PCD_DisconnectCallback_PreTreatment */	
  USBD_LL_DevDisconnected((USBD_HandleTypeDef*)hpcd->pData);
#t/* USER CODE BEGIN HAL_PCD_DisconnectCallback_PostTreatment */
#t
#t/* USER CODE END HAL_PCD_DisconnectCallback_PostTreatment */	
}
...
#endif /* USE_HAL_PCD_REGISTER_CALLBACKS */
#t/* USER CODE BEGIN USB_HS_FIFO_Configuration */
#tHAL_PCDEx_SetRxFiFo(&hpcd_USB_OTG_HS, 0x200);
#tHAL_PCDEx_SetTxFiFo(&hpcd_USB_OTG_HS, 0, 0x40);
#tHAL_PCDEx_SetTxFiFo(&hpcd_USB_OTG_HS, 1, 0x80);
#t/* USER CODE END USB_HS_FIFO_Configuration */
#t}
[/#if]
[#if handleNameUSB_FS == "FS"]
#t/* Link the driver to the stack. */
...
{
#t HAL_PCD_SetTestMode(pdev->pData, testmode);
