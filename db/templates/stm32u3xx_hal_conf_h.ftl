...
[#assign allModules = ["ADC","CCB","COMP","CRC","AES","DAC","DMA","FDCAN","GTZC","HASH","HCD","I2C","I3C","ICACHE","IRDA","IWDG","LPTIM","MDF","MMC","OCTOSPI","OPAMP","PCD","PKA","RAMCFG","RNG","RTC","SAI","SD","SMARTCARD","SMBUS","SPI","TIM","TSC","UART","USART","WWDG","HSPI"]]
[#list allModules as module]
    [#if isModuleUsed(module)]
[#compress]#define HAL_${module?replace("QUADSPI","QSPI")?replace("OCTOSPI","XSPI")?replace("HSPI","XSPI")?replace("AES","CRYP")?replace("SCRYP","CRYP")?replace("ADF","MDF")}_MODULE_ENABLED[/#compress]
	[#else]
[#compress]/*#define HAL_${module?replace("QUADSPI","QSPI")?replace("OCTOSPI","XSPI")?replace("HSPI","XSPI")?replace("AES","CRYP")?replace("SCRYP","CRYP")?replace("ADF","MDF")}_MODULE_ENABLED   */[/#compress]
	[/#if]	
  [/#list] 
...
/**
  ...
  */
  ...
  #define LSI_VALUE                                 [#if lsi_value??]${lsi_value}[#else]32000[/#if]UL     /*!< Value of the Internal Low Speed oscillator in Hz.                      
                                                                                                            The real value may vary depending on the variations in
                                                                                                            voltage and temperature. */
#endif /* LSI_VALUE */                                                
/**
