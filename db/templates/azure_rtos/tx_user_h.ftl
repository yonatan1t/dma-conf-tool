...
[#if FamilyName=="STM32C0" || FamilyName=="STM32N6" || FamilyName=="STM32U3" || FamilyName=="STM32U0" || FamilyName=="STM32H5" || FamilyName=="STM32U5" || FamilyName=="STM32WBA"]
/*                                                           6.3.0        */
[#else]
/*                                                           6.1.11       */
[/#if]
...
/* Define various build options for the ThreadX port.  The application should either make changes
   ...
   For maximum speed, the following should be defined:
	...
	[#if FamilyName=="STM32C0" || FamilyName=="STM32U5" || FamilyName=="STM32U3" || FamilyName=="STM32U0" || FamilyName=="STM32H5" || FamilyName=="STM32WBA" || FamilyName=="STM32N6"]
...
[/#if]
[#if (!FamilyName?lower_case?starts_with("stm32mp2")) && (!FamilyName?lower_case?starts_with("stm32wba")) && (!FamilyName?lower_case?starts_with("stm32n6"))]
...
[#if FamilyName=="STM32C0" || FamilyName=="STM32U5" || FamilyName=="STM32H5" || FamilyName=="STM32U0" || FamilyName=="STM32N6" || FamilyName=="STM32U3" || FamilyName=="STM32WBA" || FamilyName=="STM32N6"]
...
[#if ((FamilyName=="STM32N6") || (FamilyName=="STM32WBA"))]
...
[#else]
   [#if  ((FamilyName!="STM32N6") && (ide=="Makefile" || ide=="CMake"))]
   [#else]
