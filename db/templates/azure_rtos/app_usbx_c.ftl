...
[#if (REG_UX_DEVICE_CORE_value  == "true" || REG_UX_HOST_CORE_value == "true") && UX_STANDALONE_ENABLED_Value == "1" && AZRTOS_APP_MEM_ALLOCATION_METHOD_STANDALONE_VAL  != "0" ]
...
[#if (USBXDEVICE_ENABLED_value  == "true" || USBXHOST_ENABLED_value == "true") && UX_STANDALONE_ENABLED_Value == "0" && AZRTOS_APP_MEM_ALLOCATION_METHOD_VAL  != "0" ]
  UCHAR *pointer;
...
[#if (REG_UX_DEVICE_CORE_value  == "true" || REG_UX_HOST_CORE_value == "true")]
[#if UX_STANDALONE_ENABLED_Value == "0"]
