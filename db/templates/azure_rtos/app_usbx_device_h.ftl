...
[#assign UX_DEVICE_CCID_value = ""]
[#assign UX_DEVICE_PRINTER_value = ""]
[#assign UX_DEVICE_VIDEO_value = ""]
...
[#if SWIP.defines??]
  [#list SWIP.defines as definition]
	...
	[#if name == "UX_DEVICE_AUDIO_PLAYBACK"]
	  [#assign UX_DEVICE_AUDIO_PLAYBACK_value = value]
	[/#if]
	[#if name == "UX_DEVICE_AUDIO_RECORDING"]
      [#assign UX_DEVICE_AUDIO_RECORDING_Value = value]
    [/#if]
...
[/#if]
[#if (UX_DEVICE_AUDIO_PLAYBACK_value??) && (UX_DEVICE_AUDIO_PLAYBACK_value == "1")]
   [#assign USBX_DEVICE_CLASS_NB = USBX_DEVICE_CLASS_NB+1]
[/#if]
[#if (UX_DEVICE_AUDIO_RECORDING_Value??) && (UX_DEVICE_AUDIO_RECORDING_Value == "1")]
   [#assign USBX_DEVICE_CLASS_NB = USBX_DEVICE_CLASS_NB+1]
[/#if]
[#if ((UX_DEVICE_AUDIO_PLAYBACK_value??) && (UX_DEVICE_AUDIO_PLAYBACK_value == "1")) || ((UX_DEVICE_AUDIO_RECORDING_Value??) && (UX_DEVICE_AUDIO_RECORDING_Value == "1")) ]
...
[/#if]
[#if FamilyName?lower_case?starts_with("stm32wba") || FamilyName?lower_case?starts_with("stm32n6")]
