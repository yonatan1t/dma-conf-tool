...
[#if SWIP.defines??]
  [#list SWIP.defines as definition]
	...
	[/#if]
	 [#if name == "Addons_DHCP_Client"]
     [#assign Addons_DHCP_Client_value = value]
     [/#if]
      [#if name == "Addons_DHCP_Server"]
      [#assign Addons_DHCP_Server_value = value]
      [/#if]
   [/#list]
[/#if]
[/#list]
...
[#if (FamilyName!="STM32N6" || (FamilyName=="STM32N6" && Addons_DHCP_Client_value == "true" ))]
