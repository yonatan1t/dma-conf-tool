...
[#assign TRANSFER_NOTIFICATION_value = "Custom"]
...
[#if SWIP.defines??]
  [#list SWIP.defines as definition]
	...
	[#if name == "LX_STANDALONE_ENABLE"]
      [#assign LX_STANDALONE_ENABLE = value]
    [/#if]
...
extern __IO UINT xspi_rx_cplt;
extern __IO UINT xspi_tx_cplt;
[/#if]
...
#define LX_STM32_XSPI_DEFAULT_TIMEOUT                    (10 * 1000)
...
#define LX_STM32_XSPI_CURRENT_TIME                              HAL_GetTick
...
[#if glue_api == "DMA_API" && TRANSFER_NOTIFICATION_value != "Custom"]
