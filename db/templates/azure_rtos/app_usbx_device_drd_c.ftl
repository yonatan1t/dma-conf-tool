...
[#assign REG_UX_DEVICE_AUDIO_PLAYBACK_value = "0" ]
[#assign REG_UX_DEVICE_AUDIO_RECORDING_value = "0" ]
[#compress]
...
[#if SWIP.defines??]
  [#list SWIP.defines as definition]
    ...
    [/#if]
	[#if name == "UX_DEVICE_AUDIO"]
      [#assign UX_DEVICE_AUDIO_value = value]
    [/#if]
    ...
    [/#if]
	[#if name == "USBD_HID_MOUSE_PARAMETER_REPORT_ID"]
      [#assign USBD_HID_MOUSE_PARAMETER_REPORT_ID_value = value]
    [/#if]
	[#if name == "UX_DEVICE1_enabled"]
      [#assign UX_DEVICE1_enabled_value = value]
    [/#if]
	[#if name == "UX_DEVICE2_enabled"]
      [#assign UX_DEVICE2_enabled_value = value]
    [/#if]
...
[/#compress]
    ...
    [#if UX_DEVICE_PRINTER_value == "1"]
      [#assign USBX_DEVICE_CLASS_NB = USBX_DEVICE_CLASS_NB+1]
    [/#if]
	[#if (UX_DEVICE_AUDIO_PLAYBACK_ENABLED_Value??) && (UX_DEVICE_AUDIO_PLAYBACK_ENABLED_Value == "1")]
      [#assign USBX_DEVICE_CLASS_NB = USBX_DEVICE_CLASS_NB+1]
    [/#if]
	[#if UX_DEVICE_AUDIO_RECORDING_ENABLED_Value?? && UX_DEVICE_AUDIO_RECORDING_ENABLED_Value == "1"]
      [#assign USBX_DEVICE_CLASS_NB = USBX_DEVICE_CLASS_NB+1]
    [/#if]
...
[/#if]
[#if (REG_UX_DEVICE_AUDIO_PLAYBACK_value == "1") || (REG_UX_DEVICE_AUDIO_RECORDING_value == "1")]
...
[/#if]
[#if ((REG_UX_DEVICE_AUDIO_PLAYBACK_value??) && (REG_UX_DEVICE_AUDIO_PLAYBACK_value == "1")) || ((REG_UX_DEVICE_AUDIO_RECORDING_value??) && (REG_UX_DEVICE_AUDIO_RECORDING_value == "1"))]
...
[#if FamilyName?lower_case?starts_with("stm32n6")]
 [#if UX_DEVICE1_enabled_value?? && UX_DEVICE1_enabled_value == "1"]
extern PCD_HandleTypeDef           hpcd_USB_OTG_HS1;
  [/#if]
  [#if UX_DEVICE2_enabled_value?? && UX_DEVICE2_enabled_value == "1"]
...
[#if Dual_Role_Device_Enabled_value?? && Dual_Role_Device_Enabled_value == "0"]
...
[#else]
  ULONG device_framework_hs_length;
[/#if]  ULONG device_framework_fs_length;
...
[#if REG_UX_DEVICE_HID_MOUSE_value == "1"]
  ...
  hid_mouse_parameter.ux_device_class_hid_parameter_report_id      = ${USBD_HID_MOUSE_PARAMETER_REPORT_ID_value};
...
[#if UX_DEVICE_CLASS_AUDIO_INTERRUPT_SUPPORT_value == "1"]
  ...
  audio_parameter.ux_device_class_audio_parameter_status_size = USBD_AUDIO_InterruptStatusSize();
  audio_parameter.ux_device_class_audio_parameter_status_queue_size = USBD_AUDIO_InterruptStatusQueueSize();
