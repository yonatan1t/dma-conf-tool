...
[#if SWIP.defines??]
  ...
  [#if name == "LINK_NOR_OSPI_DRIVER"]
    ...
    [/#if]
	[#if name == "LINK_NOR_XSPI_DRIVER"]
      [#assign LINK_NOR_XSPI_DRIVER_value = value]
    [/#if]

     [#if name == "FORMAT_NOR_XSPI_MEDIA"]
      [#assign FORMAT_NOR_XSPI_MEDIA_value = value]
    [/#if]
  ...
  [#if name == "LX_NOR_USE_OSPI_DRIVER"]
    ...
    [/#if]
  [#if name == "LX_NOR_USE_XSPI_DRIVER"]
      [#assign LX_NOR_USE_XSPI_DRIVER_value = value]
    [/#if]
...
[#if FX_STANDALONE_ENABLE_value !="1"]
[#if FX_LX_NOR_INTERFACE_value?? && LX_NOR_USE_XSPI_DRIVER_value??]
[#if FX_LX_NOR_INTERFACE_value == "1" && LX_NOR_USE_XSPI_DRIVER_value =="true"]
[#if LINK_NOR_XSPI_DRIVER_value == "1" || FORMAT_NOR_XSPI_MEDIA_value == "1"]
/* Buffer for FileX FX_MEDIA sector cache. */
...
[#if LX_NOR_USE_XSPI_DRIVER_value??]
[#if FX_LX_NOR_INTERFACE_value == "1" && LX_NOR_USE_XSPI_DRIVER_value =="true"]
[#if FORMAT_NOR_XSPI_MEDIA_value == "1" || LINK_NOR_XSPI_DRIVER_value == "1"]  
...
[#if FX_LX_NOR_INTERFACE_value == "1" && LX_NOR_USE_XSPI_DRIVER_value?? && LX_NOR_USE_XSPI_DRIVER_value =="true"]
[#if FORMAT_NOR_XSPI_MEDIA_value == "1"]
...
[#if LINK_NOR_XSPI_DRIVER_value == "1"]
