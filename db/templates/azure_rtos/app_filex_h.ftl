...
[/#if]
[#if name?contains("LX_NOR_USE_XSPI_DRIVER") && value == "true"]
...
[#if name?contains("FX_LX_NOR_INTERFACE")  && LX_NOR_USE_XSPI_DRIVER_value?? && LX_NOR_USE_XSPI_DRIVER_value =="true" && value == "1"]
