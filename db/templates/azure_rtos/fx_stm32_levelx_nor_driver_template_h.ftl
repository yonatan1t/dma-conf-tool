...
[#if define.name?contains("LX_NOR_USE_SIMULATOR_DRIVER") && define.value?contains("true")]
#define LX_NOR_SIMULATOR_DRIVER
[/#if]
[#if define.name?contains("LX_NOR_USE_OSPI_DRIVER") && define.value?contains("true")]
#define LX_NOR_OSPI_DRIVER
[/#if]
[#if define.name?contains("LX_NOR_USE_XSPI_DRIVER") && define.value?contains("true")]
#define LX_NOR_XSPI_DRIVER
[/#if]
[#if define.name?contains("LX_NOR_USE_CUSTOM_DRIVER")&& define.value?contains("true")]
#define LX_NOR_CUSTOM_DRIVER
[/#if]

[#if define.name?contains("FX_LX_NOR_CUSTOM_DRIVER_NAME")]
[#assign FX_LX_NOR_CUSTOM_DRIVER_NAME_value = define.value]
[/#if]
[#if define.name?contains("FX_LX_NOR_CUSTOM_DRIVER_ID")]
[#assign FX_LX_NOR_CUSTOM_DRIVER_ID_value = define.value]
[/#if]
[#if define.name?contains("FX_LX_NOR_CUSTOM_DRIVER_INIT")]
[#assign FX_LX_NOR_CUSTOM_DRIVER_INIT_value = define.value]
[/#if]
[/#list]
[/#if]
[/#list]
...
[#if FamilyName?lower_case?starts_with("stm32u5")]
...
#define NOR_CUSTOM_DRIVER_ID          ${FX_LX_NOR_CUSTOM_DRIVER_ID_value}
#define NOR_CUSTOM_DRIVER_NAME    "${FX_LX_NOR_CUSTOM_DRIVER_NAME_value}"
#define NOR_CUSTOM_DRIVER_INIT    ${FX_LX_NOR_CUSTOM_DRIVER_INIT_value}
