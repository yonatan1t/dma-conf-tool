...
[#if TX_APP_GENERATE_INIT_CODE_value != "false"]
[#if TX_APP_CREATION_value != "0"]
[#if (familyName?starts_with("stm32n6"))]
/**
...
[/#if]
  ...
  /**
[#if (familyName?starts_with("stm32n6") || familyName?starts_with("stm32wba") || familyName?starts_with("stm32u3") || familyName?starts_with("stm32u5") || familyName?starts_with("stm32u0") || familyName?starts_with("stm32h5") || familyName?starts_with("stm32c0"))]
