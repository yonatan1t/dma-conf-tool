...
/**
  ...
  ******************************************************************************
  */
 [#assign USBD_HAL_ISOINCOMPLETE_CALLBACK_value = "0" ]
...
[#if DIE=="DIE481" || DIE=="DIE476" || FamilyName?lower_case == "stm32n6" || FamilyName?lower_case == "stm32mp13" || FamilyName?lower_case == "stm32wba"]
...
[#if FamilyName?lower_case == "stm32h5" || FamilyName?lower_case == "stm32c0" || FamilyName?lower_case == "stm32u3"]
#define UX_DCD_STM32_MAX_ED                   8
#define UX_HCD_STM32_MAX_NB_CHANNELS          8
[/#if]
...
[#if (def_name?contains("UX_DEVICE_VIDEO") && def_value == "1") || (def_name?contains("UX_DEVICE_AUDIO_CORE") && def_value == "1")]
[#assign USBD_HAL_ISOINCOMPLETE_CALLBACK_value = "1" ]
[/#if]
[/#list]
[/#if]
[/#list]
[#if USBD_HAL_ISOINCOMPLETE_CALLBACK_value == "1"]
