...
[#assign REG_UX_HOST_AUDIO_value = "0" ]
...
[#if SWIP.defines??]
  [#list SWIP.defines as definition]
    ...
    [/#if]
	[#if name == "REG_UX_HOST_AUDIO"]
      [#assign REG_UX_HOST_AUDIO_value = value]
    [/#if]
    ...
    [/#if]
	[#if name == "UX_HOST1_enabled"]
      [#assign UX_HOST1_enabled_value = value]
    [/#if]
	[#if name == "UX_HOST2_enabled"]
      [#assign UX_HOST2_enabled_value = value]
    [/#if]
	[#if name == "UX_HOST_enabled_HS"]
      [#assign UX_HOST_enabled_HS_value = value]
    [/#if]
	[#if name == "UX_HOST_enabled_FS"]
      [#assign UX_HOST_enabled_FS_value = value]
    [/#if]
   [/#list]
[/#if]
[/#list]
...
[#if UX_HOST1_enabled_value?? && UX_HOST1_enabled_value == "1"]
extern HCD_HandleTypeDef hhcd_USB_OTG_HS1;
[/#if]
[#if UX_HOST2_enabled_value?? && UX_HOST2_enabled_value == "1"]
extern HCD_HandleTypeDef hhcd_USB_OTG_HS2;
[/#if]
[#if UX_HOST_enabled_HS_value?? && UX_HOST_enabled_HS_value == "1"]
extern HCD_HandleTypeDef hhcd_USB_OTG_HS;
[/#if]
[#if UX_HOST_enabled_FS_value?? && UX_HOST_enabled_FS_value == "1"]
