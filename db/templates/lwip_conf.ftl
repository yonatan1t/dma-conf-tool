...
#define ${definition.name}  ${definition.value}
            [/#if]
            [#if (FamilyName != "STM32H7RS") && (definition.name=="MEMP_NUM_SYS_TIMEOUT") && (definition.value != "valueNotSetted") && (definition.value == "5")]
...
#define ${definition.name}  ${definition.value}
            [/#if]
            [#if (FamilyName == "STM32H7RS") && (definition.name=="MEMP_NUM_SYS_TIMEOUT") && (definition.value != "valueNotSetted") && (definition.value == "6")]
/*----- Value in opt.h for ${definition.name}: (LWIP_TCP + IP_REASSEMBLY + LWIP_ARP + (2*LWIP_DHCP) + LWIP_AUTOIP + LWIP_IGMP + LWIP_DNS + (PPP_SUPPORT*6*MEMP_NUM_PPP_PCB) + (LWIP_IPV6 ? (1 + LWIP_IPV6_REASS + LWIP_IPV6_MLD) : 0)) -*/
#define ${definition.name}  ${definition.value}
            [/#if]
