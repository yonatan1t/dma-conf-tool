...
[#if DIE == "DIE478"]
  [#assign allModules = ["ADC","CEC","CRC","AES","DAC","DCACHE","DCMI","DTS","FDCAN","GTZC","HASH","IWDG","I2C","I3C","I2S","LPTIM","NAND","NOR","OCTOSPI","OTFDEC","PKA","RNG","RTC","SD","SDIO","MMC","SPI","SRAM","TIM","RAMCFG","UART","USART","WWDG","PSSI", "ICACHE", "PCD", "HCD", "SMARTCARD","SMBUS","IRDA"]]
[#elseif DIE == "DIE474"]
...
[#else]
  [#assign allModules = ["ADC","CEC","COMP","CORDIC","CRC","AES","DAC","DCACHE","DCMI","DTS","ETH","FDCAN","FMAC","GTZC","HASH", "HCD","IRDA","IWDG","I2C","I3C","I2S","LPTIM","NAND","NOR","OPAMP", "OCTOSPI","OTFDEC","PKA","RNG","RTC","SAI","SD","SDIO","SDRAM","MMC", "SMARTCARD","SMBUS","SPI","SRAM","TIM","RAMCFG","UART","USART","WWDG","PSSI", "ICACHE", "PCD"]]
[/#if]
...
/**
  ...
  */
  ...
  #define HSE_VALUE    [#if hse_value??]${hse_value}[#else]16000000[/#if]U /*!< Value of the External oscillator in Hz */
#endif /* HSE_VALUE */

#if !defined  (HSE_STARTUP_TIMEOUT)
  #define HSE_STARTUP_TIMEOUT    [#if HSE_Timout??]${HSE_Timout}[#else]100[/#if]U   /*!< Time out for HSE start up, in ms */
