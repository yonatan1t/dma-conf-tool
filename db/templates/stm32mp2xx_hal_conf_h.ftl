...
#endif /* CORE_CA35 */
  [#assign allModules = ["ADC", "BSEC", "CRYP", "CRC", "DCACHE", "DCMI", "DCMIPP", "DSI", "ETH", "FDCAN", "HASH", "HSEM", "I2C", "I3C", "I2S", "ICACHE", "IPCC", "IRDA", "IWDG", "LPTIM", "LTDC", "LVDS", "MDF", "MMC" ,"NAND" , "NOR" , "OSPI" , "OCTOSPI" , "OTFDEC" , "PCD" , "PKA" , "PSSI" , "RAMCFG" , "RIF" , "RNG" , "RTC" , "SAI" , "SD" , "SMARTCARD" , "SMBUS" , "SPDIFRX" , "SPI" , "SRAM" , "TIM" , "UART" , "USART" , "WWDG"]]
