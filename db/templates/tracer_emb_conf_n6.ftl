...
#define TRACER_EMB_TX_GPIO_ENABLE_CLOCK()            LL_AHB4_GRP1_EnableClock(LL_AHB4_GRP1_PERIPH_GPIO${UART_TX_GPIO_PORT})
...
#define TRACER_EMB_RX_GPIO_ENABLE_CLOCK()            LL_AHB4_GRP1_EnableClock(LL_AHB4_GRP1_PERIPH_GPIO${UART_RX_GPIO_PORT})

#define TRACER_EMB_ENABLE_CLK_USART()                ${UARTenableClock}
#define TRACER_EMB_DISABLE_CLK_USART()               ${UARTdisableClock}
#define TRACER_EMB_SET_CLK_SOURCE_USART()            /* No need for clock source selection in case of ${UARTinstance} */
#define TRACER_EMB_USART_IRQ                         ${UARTinstance}_IRQn
#define TRACER_EMB_USART_IRQHANDLER                  ${UARTinstance.replace("IRQn", "IRQHandler")}
#define TRACER_EMB_TX_IRQ_PRIORITY                   ${UART_TX_IRQ}
...
#define TRACER_EMB_TX_DMA_REQUEST                    LL_${UART_TX_DMA}_REQUEST_${UART_TX_DMA_REQUEST}
