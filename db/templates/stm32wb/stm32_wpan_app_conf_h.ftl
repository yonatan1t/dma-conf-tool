...
[#assign CFG_BLE_EXTRA_DATA_BUFFER_SIZE = 500]
[#assign CFG_BLE_EXTRA_DATA_STATUS = "0"]
...
[#assign CFG_BLE_MAX_ADD_EATT_BEARERS = 0]
...
[#list SWIPdatas as SWIP]
	[#if SWIP.defines??]
		[#list SWIP.defines as definition]
            ...
            [/#if]
			[#if (definition.name == "CFG_BLE_EXTRA_DATA_BUFFER_SIZE")]
                [#assign CFG_BLE_EXTRA_DATA_BUFFER_SIZE = definition.value]
            [/#if]
			[#if (definition.name == "CFG_BLE_EXTRA_DATA_STATUS")]
                [#assign CFG_BLE_EXTRA_DATA_STATUS = definition.value]
            [/#if]
...
--]
            ...
            [/#if]
			[#if (definition.name == "CFG_BLE_MAX_ADD_EATT_BEARERS")]
                [#assign CFG_BLE_MAX_ADD_EATT_BEARERS = definition.value]
            [/#if]
 ...
 *     - Range: 0 .. 4
 */
#define CFG_BLE_MAX_ADD_EATT_BEARERS            (${CFG_BLE_MAX_ADD_EATT_BEARERS})

[#if (BLE_TRANSPARENT_MODE_UART = 1) && (CFG_BLE_EXTRA_DATA_STATUS = "1")]
/**
* Size of the RAM buffer extra_data_buffer allocated for the extension of Host commands
*     - Range: 0..500 (at least >250)
*/
#define CFG_BLE_EXTRA_DATA_BUFFER_SIZE          (${CFG_BLE_EXTRA_DATA_BUFFER_SIZE})
[/#if]
