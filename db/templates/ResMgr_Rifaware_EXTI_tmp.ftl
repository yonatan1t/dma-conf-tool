 [#ftl]
   ...
   [#if RifAwareIPName?starts_with("EXTI") && !RifAwareIPFeatureList.value[1]?matches("-")]
   [#assign ParamPrefix="_RESOURCE"]
   ...
   #t /* ${FeatureName} */
   #n
   #tif (ResMgr_Request(RESMGR_RESOURCE_RIF_${RESMGR_IP}, RESMGR_EXTI${ParamPrefix}${FeatureIDList[FeatureName?index]}) != RESMGR_STATUS_ACCESS_OK)
   #t{
