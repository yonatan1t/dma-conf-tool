...
[#assign IpInstanceFS = ""]
[#assign IpInstanceHS = ""]
[#assign fileNameFS = "usb_otg_fs_"]
[#assign fileNameHS = "usb_otg_hs_"]
[#if BspIpDatas??]
...
[/#compress]
[/#list]
[#assign virtualFS = common.fileExist(mxTmpFolder+"/usb_otg_fs1_vars.tmp")]  [#-- Check if FS1 TMP  file exists --]
[#assign virtualHS = common.fileExist(mxTmpFolder+"/usb_otg_hs1_vars.tmp")]  [#-- Check if HS1 TMP  file exists --]

[#if virtualFS=="true" && handleNameFS == "FS"]
    [#assign fileNameFS = "usb_otg_fs1_"]
[/#if]
[#if  virtualHS=="true" && handleNameHS == "HS"]
    [#assign fileNameHS = "usb_otg_hs1_"]
[/#if]
...
[#if handleNameFS == "FS"]
[@common.optinclude name=mxTmpFolder+"/"+fileNameFS+"vars.tmp"/]
[/#if]
[#if handleNameHS == "HS"]
[@common.optinclude name=mxTmpFolder+"/"+fileNameHS+"vars.tmp"/]
[/#if]
...
[@common.optinclude name=mxTmpFolder+"/"+fileNameFS+"Msp.tmp"/]
[/#if]
[/#if]
...
[#if includeMspDone == 0]
[#assign includeMspDone = 1]
[@common.optinclude name=mxTmpFolder+"/"+fileNameHS+"Msp.tmp"/]
[/#if]
[/#if]
...
[@common.optinclude name=mxTmpFolder+"/"+fileNameFS+"HalInit.tmp"/]
...
[@common.optinclude name=mxTmpFolder+"/"+fileNameHS+"HalInit.tmp"/]
