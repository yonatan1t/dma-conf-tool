        ...
        [#list SWIP.defines as definition]
            ...
            [#if definition.name == "TIMinstance"]
                [#assign TIMinstance = definition.value]
                   [#assign APB = "APB2"]
                   [#if TIMinstance=="TIM2"||TIMinstance=="TIM3"||TIMinstance=="TIM4"||TIMinstance=="TIM5"||TIMinstance=="TIM6"||TIMinstance=="TIM7"||TIMinstance=="TIM12"||TIMinstance=="TIM13"||TIMinstance=="TIM14"]
                   [#assign APB = "APB1"]
                   [/#if]
            [/#if]
            ...
            [/#if]
            [#if definition.name == "Tim1OutputFreq_Value"]
                 [#assign Tim1OutputFreq_Value = definition.value]
            [/#if]
            [#if definition.name == "Tim2OutputFreq_Value"]
                 [#assign Tim2OutputFreq_Value = definition.value]
            [/#if]
...
#define UCPD_INSTANCE0_ENABLEIRQ  do{                                                                 \
                                        NVIC_SetPriority(${USBPD_PORT0_IRQ},${prioucpd});                              \
...
[#if  APB=="APB1"]
#define TIMX_CLK_FREQ                  ${Tim1OutputFreq_Value}U
[#else]
#define TIMX_CLK_FREQ                  ${Tim2OutputFreq_Value}U
[/#if]
