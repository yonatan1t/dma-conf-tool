...
[#if myHash["BLE_MODE_PERIPHERAL_CENTRAL"] == "Enabled"]
  uint16_t ${SERVICE_SHORT_NAME_UpperCase}_periph_connHdl;
[/#if]
...
[#if (myHash["BLE_MODE_PERIPHERAL"] == "Enabled")&&(myHash["BLE_MODE_PERIPHERAL_CENTRAL"] == "Disabled")]
    case ${SERVICE_SHORT_NAME_UpperCase}_CONN_HANDLE_EVT :
      ${SERVICE_SHORT_NAME_UpperCase}_APP_Context.ConnectionHandle = p_Notification->ConnectionHandle;
[#else]
    case ${SERVICE_SHORT_NAME_UpperCase}_CENTR_CONN_HANDLE_EVT :
[/#if]
      /* USER CODE BEGIN Service${SvcNbr}_APP_CENTR_CONN_HANDLE_EVT */
              
      /* USER CODE END Service${SvcNbr}_APP_CENTR_CONN_HANDLE_EVT */
      break;
[#if (myHash["BLE_MODE_PERIPHERAL_CENTRAL"] == "Enabled")]

    case ${SERVICE_SHORT_NAME_UpperCase}_PERIPH_CONN_HANDLE_EVT :
      /* USER CODE BEGIN Service${SvcNbr}_APP_PERIPH_CONN_HANDLE_EVT */

      /* USER CODE END Service${SvcNbr}_APP_PERIPH_CONN_HANDLE_EVT */
      break;

[/#if]
    case ${SERVICE_SHORT_NAME_UpperCase}_DISCON_HANDLE_EVT :
[#if (myHash["BLE_MODE_PERIPHERAL"] == "Enabled")&&(myHash["BLE_MODE_PERIPHERAL_CENTRAL"] == "Disabled")]
      ${SERVICE_SHORT_NAME_UpperCase}_APP_Context.ConnectionHandle = 0xFFFF;
[/#if]
...
[#if (myHash["BLE_MODE_PERIPHERAL"] == "Enabled")&&(myHash["BLE_MODE_PERIPHERAL_CENTRAL"] == "Disabled")]
  ...
  if (notification_on_off != [@capitalizeServChar characteristic/]_NOTIFICATION_OFF && ${SERVICE_SHORT_NAME_UpperCase}_APP_Context.ConnectionHandle != 0xFFFF)
  {
    ${SERVICE_SHORT_NAME_UpperCase}_NotifyValue([@customServChar characteristic/], &${SERVICE_SHORT_NAME_LowerCase}_notification_data, ${SERVICE_SHORT_NAME_UpperCase}_APP_Context.ConnectionHandle);
  }
[#elseif (myHash["BLE_MODE_PERIPHERAL_CENTRAL"] == "Enabled")]

  if (notification_on_off != [@capitalizeServChar characteristic/]_NOTIFICATION_OFF && ${SERVICE_SHORT_NAME_UpperCase}_APP_Context.${SERVICE_SHORT_NAME_UpperCase}_periph_connHdl != 0xFFFF)
  {
    ${SERVICE_SHORT_NAME_UpperCase}_NotifyValue([@customServChar characteristic/], &${SERVICE_SHORT_NAME_LowerCase}_notification_data, ${SERVICE_SHORT_NAME_UpperCase}_APP_Context.${SERVICE_SHORT_NAME_UpperCase}_periph_connHdl);
  }
[#else]
...
{ 
  ...
  if (indication_on_off != [@capitalizeServChar characteristic/]_INDICATION_OFF && ${SERVICE_SHORT_NAME_UpperCase}_APP_Context.ConnectionHandle != 0xFFFF)
  {
    ${SERVICE_SHORT_NAME_UpperCase}_NotifyValue([@customServChar characteristic/], &${SERVICE_SHORT_NAME_LowerCase}_indication_data, ${SERVICE_SHORT_NAME_UpperCase}_APP_Context.ConnectionHandle);
  }
