        ...
        [#list SWIP.defines as definition]
            ...
            [#if USBPD1Used]
                ...
                [#if definition.name == "USBPD_PORT1_TX_DMA_CHANNEL"]
					...
					${USBPD_PORT0_TX_DMA_CHANNEL.split("_")}
...
[#assign str = USBPD_PORT0_DMA_RX]
#define UCPDDMA_INSTANCE0_REQUEST_RX   LL_${USBPD_PORT0_DMA_RX?replace(str,"HPDMA")}_REQUEST_${USBPD_PORT0_DMA_REQUEST_RX?replace("UCPD1","UCPD")}
...
[#assign str1 = USBPD_PORT0_DMA_TX]
#define UCPDDMA_INSTANCE0_REQUEST_TX   LL_${USBPD_PORT0_DMA_TX?replace(str1,"HPDMA")}_REQUEST_${USBPD_PORT0_DMA_REQUEST_TX?replace("UCPD1","UCPD")}
