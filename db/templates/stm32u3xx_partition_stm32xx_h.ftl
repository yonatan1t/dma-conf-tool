...
/**
  ******************************************************************************
  * @file    partition_[#if McuName?starts_with("STM32U375")]stm32u375xx.h[/#if][#if McuName?starts_with("STM32U385")]stm32u385xx.h[/#if]
  * @author  MCD Application Team
  * @brief   CMSIS [#if McuName?starts_with("STM32U375")]stm32u375xx[/#if][#if McuName?starts_with("STM32U385")]stm32u385xx[/#if] Device Initial Setup for Secure / Non-Secure Zones
...
[/#list]
[/#if]
[#if McuName?starts_with("STM32U385")]
#ifndef PARTITION_STM32U385XX_H
#define PARTITION_STM32U385XX_H
[/#if]
[#if McuName?starts_with("STM32U375")]
...
[#if McuName?starts_with("STM32U375")|| McuName?starts_with("STM32U385")]
...
//   <o.21> I3C1_EV_IRQn     	  [#if enabledIT?contains("I3C1_EV_IRQn")]<1=> Non-Secure state[#assign nonSecureIT1 = nonSecureIT1+", "+"21"/][#else]<0=> Secure state[/#if]
//   <o.22> I3C1_ER_IRQn          [#if enabledIT?contains("I3C1_ER_IRQn")]<1=> Non-Secure state[#assign nonSecureIT1 = nonSecureIT1+", "+"22"/][#else]<0=> Secure state[/#if]
...
//   <o.4>  I3C2_EV_IRQn          [#if enabledIT?contains("I3C2_EV_IRQn")]<1=> Non-Secure state[#assign nonSecureIT3 = nonSecureIT3+", "+"4"/][#else]<0=> Secure state[/#if]
//   <o.5>  I3C2_ER_IRQn          [#if enabledIT?contains("I3C2_ER_IRQn")]<1=> Non-Secure state[#assign nonSecureIT3 = nonSecureIT3+", "+"5"/][#else]<0=> Secure state[/#if]
...
//   <o.17> ADC2_IRQn             [#if enabledIT?contains("ADC2_IRQn")]<1=> Non-Secure state[#assign nonSecureIT3 = nonSecureIT3+", "+"17"/][#else]<0=> Secure state[/#if]
//   <o.27> PWR_IRQn              [#if enabledIT?contains("PWR_IRQn")]<1=> Non-Secure state[#assign nonSecureIT3 = nonSecureIT3+", "+"27"/][#else]<0=> Secure state[/#if]
//   <o.28> PWR_S_IRQn            [#if enabledIT?contains("PWR_S_IRQn")]<1=> Non-Secure state[#assign nonSecureIT3 = nonSecureIT3+", "+"28"/][#else]<0=> Secure state[/#if]
*/
