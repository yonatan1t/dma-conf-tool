...
[#if SWIP.defines??]
  [#list SWIP.defines as definition]
    ...
    [/#if]
    [#if Name == "RefParam_MEM_END_ADDRESS"]
          [#assign RefParam_MEM_END_ADDRESS_value = Value]
    [/#if]
  [/#list]
[/#if]
[/#list]
...
<flash_board>
  <pass>
    <range>CODE ${RefParam_ELOADER_ADDRESS_value} ${RefParam_MEM_END_ADDRESS_value}</range>
