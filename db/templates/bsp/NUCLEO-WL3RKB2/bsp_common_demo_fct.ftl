...
[#compress]
[#if (BUTTON?? && BUTTON == "1") || (BUTTON2?? && BUTTON2 == "1") || (BUTTON3?? && BUTTON3 == "1")][#--EXTI--]
  /**
  ...
  void HAL_GPIO_EXTI_Callback(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin)
      ...
      #t{
			[#if (BUTTON?? && BUTTON == "1")]
                	 #t#tif ((GPIOx == B1_GPIO_PORT) && (GPIO_Pin == B1_PIN))
                     #t#t{
			...
			[#if (BUTTON2?? && BUTTON2 == "1")]
                	#t#telse if ((GPIOx == B2_GPIO_PORT) && (GPIO_Pin == B2_PIN))
                	#t#t{
			...
			[#if (BUTTON3?? && BUTTON3 == "1")]
                	#t#telse if ((GPIOx == B3_GPIO_PORT) && (GPIO_Pin == B3_PIN))
                	#t#t{
