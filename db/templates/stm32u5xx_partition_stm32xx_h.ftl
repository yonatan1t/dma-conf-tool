...
[#if McuName?starts_with("STM32U545")]
//   <o.9>  USB_IRQn              [#if enabledIT?contains("USB_IRQn")]<1=> Non-Secure state[#assign nonSecureIT2 = nonSecureIT2+", "+"9"/][#else]<0=> Secure state[/#if]
[/#if]
[#if McuName?starts_with("STM32U535")]
//   <o.9>  USB_IRQn              [#if enabledIT?contains("USB_IRQn")]<1=> Non-Secure state[#assign nonSecureIT2 = nonSecureIT2+", "+"9"/][#else]<0=> Secure state[/#if]
[/#if]
...
//   <o.9>  OTG_FS_IRQn           [#if enabledIT?contains("OTG_FS_IRQn")]<1=> Non-Secure state[#assign nonSecureIT2 = nonSecureIT2+", "+"9"/][#else]<0=> Secure state[/#if]
[/#if]
[#if McuName?starts_with("STM32U5A5") || McuName?matches("STM32U5G.*")]
...
[#if McuName?starts_with("STM32U5A5")]// Interrupts 96..127[/#if][#if McuName?starts_with("STM32U5A9")]// Interrupts 96..127[/#if][#if McuName?starts_with("STM32U595")]// Interrupts 96..127[/#if][#if McuName?starts_with("STM32U599")]// Interrupts 96..127[/#if][#if McuName?matches("STM32U5G.*")]// Interrupts 96..127[/#if]
...
[#if McuName?matches("STM32U5G.*")]
//   <o.29> LSECSSD_IRQn          [#if enabledIT?contains("LSECSSD_IRQn")]<1=> Non-Secure state[#assign nonSecureIT3 = nonSecureIT3+", "+"29"/][#else]<0=> Secure state[/#if]
[/#if]
[#if McuName?starts_with("STM32U5A5") || McuName?matches("STM32U5G.*")]
...
/*
// Interrupts 96..138
//   <o.0>  I2C5_EV_IRQn          [#if enabledIT?contains("I2C5_EV_IRQn")]<1=> Non-Secure state[#assign nonSecureIT4 = nonSecureIT4+", "+"0"/][#else]<0=> Secure state[/#if]
//   <o.1>  I2C6_ER_IRQn          [#if enabledIT?contains("I2C6_ER_IRQn")]<1=> Non-Secure state[#assign nonSecureIT4 = nonSecureIT4+", "+"1"/][#else]<0=> Secure state[/#if]
//   <o.2>  I2C6_EV_IRQn          [#if enabledIT?contains("I2C6_EV_IRQn")]<1=> Non-Secure state[#assign nonSecureIT4 = nonSecureIT4+", "+"2"/][#else]<0=> Secure state[/#if]
//   <o.3>  HSPI1_IRQn            [#if enabledIT?contains("HSPI1_IRQn")]<1=> Non-Secure state[#assign nonSecureIT4 = nonSecureIT4+", "+"3"/][#else]<0=> Secure state[/#if]
*/
[#assign decVal4 = 0/]
[#if nonSecureIT4??]
...
//   <o.2>  I2C6_EV_IRQn          [#if enabledIT?contains("I2C6_EV_IRQn")]<1=> Non-Secure state[#assign nonSecureIT4 = nonSecureIT4+", "+"2"/][#else]<0=> Secure state[/#if]
//   <o.3>  HSPI1_IRQn            [#if enabledIT?contains("HSPI1_IRQn")]<1=> Non-Secure state[#assign nonSecureIT4 = nonSecureIT4+", "+"3"/][#else]<0=> Secure state[/#if]
//   <o.4>  GPU2D_IRQn            [#if enabledIT?contains("GPU2D_IRQn")]<1=> Non-Secure state[#assign nonSecureIT4 = nonSecureIT4+", "+"4"/][#else]<0=> Secure state[/#if]
//   <o.5>  GPU2D_ER_IRQn         [#if enabledIT?contains("GPU2D_ER_IRQn")]<1=> Non-Secure state[#assign nonSecureIT4 = nonSecureIT4+", "+"5"/][#else]<0=> Secure state[/#if]
//   <o.6>  GFXMMU_IRQn           [#if enabledIT?contains("GFXMMU_IRQn")]<1=> Non-Secure state[#assign nonSecureIT4 = nonSecureIT4+", "+"6"/][#else]<0=> Secure state[/#if]
//   <o.7>  LTDC_IRQn             [#if enabledIT?contains("LTDC_IRQn")]<1=> Non-Secure state[#assign nonSecureIT4 = nonSecureIT4+", "+"7"/][#else]<0=> Secure state[/#if]
//   <o.8>  LTDC_ER_IRQn          [#if enabledIT?contains("LTDC_ER_IRQn")]<1=> Non-Secure state[#assign nonSecureIT4 = nonSecureIT4+", "+"8"/][#else]<0=> Secure state[/#if]
//   <o.9>  DSI_IRQn              [#if enabledIT?contains("DSI_IRQn")]<1=> Non-Secure state[#assign nonSecureIT4 = nonSecureIT4+", "+"9"/][#else]<0=> Secure state[/#if]
//   <o.10> DCACHE2_IRQn          [#if enabledIT?contains("DCACHE2_IRQn")]<1=> Non-Secure state[#assign nonSecureIT4 = nonSecureIT4+", "+"10"/][#else]<0=> Secure state[/#if]
*/
[#assign decVal4 = 0/]
[#if nonSecureIT4??]
[#assign lll4 = nonSecureIT4?split(", ")/]
...
[#if McuName?starts_with("STM32U599") || McuName?matches("STM32U5G.*")]
/*
//   </e>
*/

/*
//   <e>Initialize ITNS 4 (Interrupts [#if McuName?matches("STM32U5G.*")]128[#else]109[/#if]..[#if McuName?starts_with("STM32U5G7")]139[#elseif McuName?starts_with("STM32U5G9")]140[#else]138[/#if])
*/
#define NVIC_INIT_ITNS4    1

/*
// Interrupts [#if McuName?matches("STM32U5G.*")]128[#else]109[/#if]..[#if McuName?starts_with("STM32U5G7")]139[#elseif McuName?starts_with("STM32U5G9")]140[#else]138[/#if]
//   <o.0>  I2C5_EV_IRQn          [#if enabledIT?contains("I2C5_EV_IRQn")]<1=> Non-Secure state[#assign nonSecureIT4 = nonSecureIT4+", "+"0"/][#else]<0=> Secure state[/#if]
//   <o.1>  I2C6_ER_IRQn          [#if enabledIT?contains("I2C6_ER_IRQn")]<1=> Non-Secure state[#assign nonSecureIT4 = nonSecureIT4+", "+"1"/][#else]<0=> Secure state[/#if]
//   <o.2>  I2C6_EV_IRQn          [#if enabledIT?contains("I2C6_EV_IRQn")]<1=> Non-Secure state[#assign nonSecureIT4 = nonSecureIT4+", "+"2"/][#else]<0=> Secure state[/#if]
//   <o.3>  HSPI1_IRQn            [#if enabledIT?contains("HSPI1_IRQn")]<1=> Non-Secure state[#assign nonSecureIT4 = nonSecureIT4+", "+"3"/][#else]<0=> Secure state[/#if]
...
//   <o.10> DCACHE2_IRQn          [#if enabledIT?contains("DCACHE2_IRQn")]<1=> Non-Secure state[#assign nonSecureIT4 = nonSecureIT4+", "+"10"/][#else]<0=> Secure state[/#if]
[#if McuName?matches("STM32U5G.*")]
//   <o.11> GFXTIM_IRQn           [#if enabledIT?contains("GFXTIM_IRQn")]<1=> Non-Secure state[#assign nonSecureIT4 = nonSecureIT4+", "+"11"/][#else]<0=> Secure state[/#if]
//   <o.12> JPEG_IRQn             [#if enabledIT?contains("JPEG_IRQn")]<1=> Non-Secure state[#assign nonSecureIT4 = nonSecureIT4+", "+"12"/][#else]<0=> Secure state[/#if]
[/#if]
*/
[#assign decVal4 = 0/]
[#if nonSecureIT4??]
