...
#define HSE_VALUE    [#if hse_value??]${hse_value}[#else]24000000[/#if]UL /*!< Value of the External oscillator in Hz */
#endif /* HSE_VALUE */
...
#define  USE_RTOS                     [#if advancedSettings?? && advancedSettings.USE_RTOS??]${advancedSettings.USE_RTOS}[#else]0U[/#if]
