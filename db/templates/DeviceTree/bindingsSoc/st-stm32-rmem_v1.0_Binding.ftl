...
[#if generateNodeRisab ==true && MemoryRegion!=""]
    [#if (srvcmx_isTargetedFw_inDTS("TF-M") && mx_tdcidContext?matches("M[0-9][0-9].*")&&(!RisabElmt?lower_case?matches("risab[12]"))) || (srvcmx_isTargetedFw_inDTS("OP-TEE")&&mx_tdcidContext?matches("A[0-9][0-9].*")) || (srvcmx_isTargetedFw_inDTS("OP-TEE")&&mx_tdcidContext?matches("M[0-9][0-9].*")&&(RisabElmt?lower_case=="risab1" || RisabElmt?lower_case=="risab2" ))]
...
${TABprop}memory-region = ${MemoryRegion?keep_before_last(",")+";"}
        [#if (srvcmx_isTargetedFw_inDTS("TF-M") && mx_tdcidContext?matches("M[0-9][0-9].*"))]
${TABprop}status = "okay";
        [/#if]
${TABnode}};
    [/#if]
...
#n
    [#if (RegionSizeList[RegionNameElmt?index]!="0x0") && ((srvcmx_isTargetedFw_inDTS("TF-M") && mx_tdcidContext?matches("M[0-9][0-9].*")) || (srvcmx_isTargetedFw_inDTS("OP-TEE")&&mx_tdcidContext?matches("A[0-9][0-9].*")) || (srvcmx_isTargetedFw_inDTS("OP-TEE")&&mx_tdcidContext?matches("M[0-9][0-9].*")&&(RisabElmt?lower_case=="risab1" || RisabElmt?lower_case=="risab2" )))]
...
#n
        ...
        [/#if]
        [#if (srvcmx_isTargetedFw_inDTS("TF-M") && mx_tdcidContext?matches("M[0-9][0-9].*")) || (srvcmx_isTargetedFw_inDTS("OP-TEE")&&mx_tdcidContext?matches("A[0-9][0-9].*")) || (srvcmx_isTargetedFw_inDTS("OP-TEE")&&mx_tdcidContext?matches("M[0-9][0-9].*")&&(RisabElmt?lower_case=="risab1" || RisabElmt?lower_case=="risab2"))]
				...
				[#list BKPSRAMTable.entrySet() as RISAFTable_params]
					...
					[#list RegionNameMap?keys as RegionNameKey]
						[#if RegionNameMap[RegionNameKey]?trim!=""]
							...
							[#list RegionSizeMap?keys as RegionSizeKey]
								[#if RegionSizeMap[RegionSizeKey]!="0x0" ]
								        [#if srvcmx_isTargetedFw_inDTS("MCUBOOT") && RisafElmt=="risaf4"]
								            [#if RegionNameMap[RegionNameKey]?trim?lower_case?contains("tfm") && EncryptMap["Encrypt"]!="false" && EncryptMap["Encrypt"]!="Disabled" ]
...
${TABprop}status = "okay";
    ...
    [#elseif srvcmx_isTargetedFw_inDTS("MCUBOOT") && RisafElmt=="risaf4"]
${TABnode}&${RisafElmt} {
#n
${TABprop}memory-region = ${MemoryRegion?keep_before_last(",")+";"}
};
...
${TABprop}st,protreg = <RISAFPROT(RISAF_REG_ID(${RegionIDList[RegionNameElmt?index]}), ${((MasterCIDRList[RegionNameElmt?index]?length)>0)?then(MasterCIDRList[RegionNameElmt?index],"RIF_UNUSED")}, ${((MasterCIDWList[RegionNameElmt?index]?length)>0)?then(MasterCIDWList[RegionNameElmt?index],"RIF_UNUSED")}, ${((MasterCIDPList[RegionNameElmt?index]?length)>0)?then(MasterCIDPList[RegionNameElmt?index],"RIF_UNUSED")}, ${SecureList[RegionNameElmt?index]}, ${EncryptList[RegionNameElmt?index]}, RIF_BREN_EN)>;
        ...
        [#elseif srvcmx_isTargetedFw_inDTS("MCUBOOT") && RisafElmt=="risaf4" && RegionNameElmt?trim?replace("-","_")?lower_case?contains("tfm")&& EncryptList[RegionNameElmt?index]!= "RIF_ENC_DIS"]
${TABnode}&${RegionNameElmt?trim?replace("-","_")?lower_case} {
#n
${TABprop}st,protreg = <RISAFPROT(RISAF_REG_ID(${RegionIDList[RegionNameElmt?index]}), ${((MasterCIDRList[RegionNameElmt?index]?length)>0)?then(MasterCIDRList[RegionNameElmt?index],"RIF_UNUSED")}, ${((MasterCIDWList[RegionNameElmt?index]?length)>0)?then(MasterCIDWList[RegionNameElmt?index],"RIF_UNUSED")}, ${((MasterCIDPList[RegionNameElmt?index]?length)>0)?then(MasterCIDPList[RegionNameElmt?index],"RIF_UNUSED")}, ${SecureList[RegionNameElmt?index]}, ${EncryptList[RegionNameElmt?index]}, RIF_BREN_EN)>;
};
...
[#if RisafElmt=="risaf2" && RegionNameList?size<=2]
    ...
    [#if !mx_socDtRPN?matches("stm32mp21")]
#n
    [#if (srvcmx_isTargetedFw_inDTS("TF-M") && mx_tdcidContext?matches("M[0-9][0-9].*")) || (srvcmx_isTargetedFw_inDTS("OP-TEE")&&mx_tdcidContext?matches("A[0-9][0-9].*"))]
&ommanager {
#n
[#if srvcmx_isTargetedFw_inDTS("TF-M")]
${TABprop}access-controllers =
[#else]
            ...
            [#if (RIF_Params.key)?? && RIF_Params.key == "RISUP"]
                ...
                [#list RISUP.entrySet() as RISUP_Params]
                    ...
                    [#if OmmanagerProp?seq_contains(RISUP_Params.key)]
                        ...
                        [#if mx_socDtRPN?matches("stm32mp23")]
                        ...
                        [#else]
                        ${TABnode}${TABprop}${TABprop}<&rifsc RIFPROT(${mx_socDtRPN?upper_case}_RIFSC_${RISUP_Params.key}_ID, ${RISUP_values})>[#if OmmanagerProp?size==ommanagerIndex];[#else],[/#if]
                        [/#if]
                    [/#if]
        [/#list]
    [/#if]
