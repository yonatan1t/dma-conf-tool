...
[#if (mx_socDtRPN == "stm32mp15")|| mx_socDtRPN=="stm32mp13"]
#include "${mxSocRPN}.dtsi"
[#elseif mxSocRPN?matches("stm32mp2.+x[cf]")]
#include "${mxSocRPN}.dtsi"
[/#if]
[#else]
...
[#if mx_ddrConfigs["general"]?? && mx_ddrConfigs["general"]["isConfigured"]?? && mx_ddrConfigs["general"]["isConfigured"]=="true" ]
	[#if mx_socDtRPN?has_content]
		[#if mx_socPtCPN?starts_with("stm32mp23") || mx_socPtCPN?starts_with("stm32mp21") ]
